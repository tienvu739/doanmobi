...
class AllHotelList extends StatefulWidget {
  ...
  @override
  State<AllHotelList> createState() => _AllHotelListState();
}

class _AllHotelListState extends State<AllHotelList> {
  List<Hotel> _hotels = [];
  ...
  Future<void> _fetchHotels() async {
    ...
    final url = Uri.parse('https://10.0.2.2:7226/api/Hotel/dsHotel');
